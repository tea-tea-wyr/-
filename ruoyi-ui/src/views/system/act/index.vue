<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开始时间" prop="astart">
      ...
      <el-form-item label="结束时间" prop="aend">
        <el-date-picker clearable size="small"
    ...
    <el-table v-loading="loading" :data="actList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开始时间" align="center" prop="astart" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.astart, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="结束时间" align="center" prop="aend" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.aend, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
