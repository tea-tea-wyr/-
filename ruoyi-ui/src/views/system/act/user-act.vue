    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属组织" prop="oid">
              <treeselect v-model="form.oid" :options="deptOptions" :show-count="true" placeholder="请选择归属组织" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="名称" prop="aname">
              <el-input v-model="form.aname" placeholder="请输入活动名称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="主题" prop="asubject">
              <el-input v-model="form.asubject" placeholder="请输入活动主题"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="标签类型" prop="atype">
              <el-input v-model="form.atype" placeholder="请输入标签类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
